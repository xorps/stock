...
pub fn cli() -> App {
    subcommand("update")
        ...
        .after_help(
            "\
This command requires that a stock lockfile already exists as generated by
`stock build` or related commands.
...
For more information about package ID specifications, see `stock help pkgid`.
",
        )
}
