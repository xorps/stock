...
impl Package {
    ...
    pub fn to_registry_toml(&self, config: &Config) -> CargoResult<String> {
        ...
        Ok(format!(
            "\
             # THIS FILE IS AUTOMATICALLY GENERATED BY STOCK\n\
             #\n\
             # When uploading crates to the registry Stock will automatically\n\
             # \"normalize\" {} files for maximal compatibility\n\
             # with all versions of Stock and also rewrite `path` dependencies\n\
             # to registry (e.g., crates.io) dependencies\n\
             #\n\
             # If you believe there's an error in this file please file an\n\
             # issue against the stock repository. If you're\n\
             # editing this file be aware that the upstream {}\n\
